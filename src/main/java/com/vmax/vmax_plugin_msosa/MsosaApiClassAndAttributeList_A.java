...
/**
 * version with activity nodes and edges
 * only call behavior action, initial node, activity final node, control flow
 * this is used for the performance evalauitons
*/
public class MsosaApiClassAndAttributeList_A extends ApiClassAndAttributeList {

    public MsosaApiClassAndAttributeList_A(String classUriPrefix, String attributeUriPrefix, String instanceUriPrefix) {
